...
import com.alpha.adapter.MyFragmentPagerAdapter;
...
public class SortFragment extends BaseFragment {
    ...
    public static String[] TITLES = { "万足银", "千足银", "足银", "S925", "珠宝", "销售配套",
            "银料" };
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.newsort, container, false);
        viewPager = (ViewPager) view.findViewById(R.id.id_viewpager);
        tabPageIndicator = (TabPageIndicator) view
                .findViewById(R.id.id_tabpageindicator);

        /*
         * 将Fragment加入集合
         */
        S9999Fragment s9999Fragment = new S9999Fragment();
        S999Fragment s999Fragment = new S999Fragment();
        S99Fragment s99Fragment = new S99Fragment();
        S925Fragment s925Fragment = new S925Fragment();
        JewelryFragment jewelryFragment = new JewelryFragment();
        SupportingSalesFragment supportingSalesFragment = new SupportingSalesFragment();
        SilverMaterialFragment silverMaterialFragment = new SilverMaterialFragment();
        list = new ArrayList<>();
        list.add(s9999Fragment);
        list.add(s999Fragment);
        list.add(s99Fragment);
        list.add(s925Fragment);
        list.add(jewelryFragment);
        list.add(supportingSalesFragment);
        list.add(silverMaterialFragment);
